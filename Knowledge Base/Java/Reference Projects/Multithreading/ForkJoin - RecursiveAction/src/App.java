...
public class App
{
    ...
    public static void main(String[] args)
    {
        ...
        SimpleRecursiveAction   objSimpleRecursiveAction        = new SimpleRecursiveAction(120);

        /*
            - The ForkJoinPool is created.
            - The ForkJoinPool is allocated x8 threads given x8 cores on laptop.
            - Create an object which extended RecursiveAction.
            - Initially:
        
                - Pass this object into ForkJoinPool via .invoke().
                - The overridden compute() will run
            ...
            - RecursiveAction is suitable when do not need to return any value.
        */
        objForkJoinPool.invoke(objSimpleRecursiveAction);
    }
}
